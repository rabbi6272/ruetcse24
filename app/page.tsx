  ...
  return (
    <div className="min-h-screen bg-[#1a2421] text-white overflow-x-hidden">
      ...
      <div className={`${anonymous.className} w-full p-2.5 text-center`}>
        ...
        <p className="text-lg mt-2.5 px-5 xl:px-10">
          "Through logic and innovation, we turn ideas into reality. From
          groundbreaking code to intelligent systems – we shape the world of
          tomorrow."
        </p>
      </div>
